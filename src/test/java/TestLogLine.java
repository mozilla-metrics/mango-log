...
public class TestLogLine {
	...
	public void testValidateSplitMarketplaceLine() {
		String v = "63.245.220.240 marketplace.firefox.com - [15/May/2013:00:00:05 -0700] \"POST /reviewers/review_viewing HTTP/1.1\" 200 783 \"https://marketplace.firefox.com/reviewers/apps/review/image-uploader\" \"Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:21.0) Gecko/20100101 Firefox/21.0\" \"lang=\"en-US\054\"; region=us; sessionid=\".eJxrYKotZNQI5UouLkqLL8nPTs0rZApVSA0wcA0uK4kqcDNO9Hf3iHTNz3Iur0hzDA0rMi03L88sZA7lKkktLknOz8_OTC1kCWUrzy_KTk0pZA3ljU8sLcmILy1OLYrPTClk62K--iAuVAhJNCkxGWhNSiF7qFpKVmJeen58UlF-OVAmM0UPpErPCcL1dHGCquQo1QMAZN48cQ:1UbvRp:abr1TatM8ygMVRaEkmF3YPBAmes\"; multidb_pin_writes=y\" \"DNT:1\" \"X-MOZ-B2G-DEVICE:- X-MOZ-B2G-MCC:- X-MOZ-B2G-MNC:- X-MOZ-B2G-SHORTNAME:- X-MOZ-B2G-LONGNAME:-\"";
		LogLine ll;
		try {
			ll = new LogLine(v);
			assertEquals(ll.validateSplitCount(), 12);
